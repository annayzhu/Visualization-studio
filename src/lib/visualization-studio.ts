...
export const defaultVisualizationSettings: VisualizationSettings = {
  ...
  continuousLow: "#EDF4F3",
  continuousHigh: "#245F69",
  divergingLow: "#286F83",
  divergingMid: "#F8F7F3",
...
export const journalThemes: Record<JournalThemeId, JournalTheme> = {
  ...
  "cn-beihai": {
    ...
    name: "柴染棕",
    description: "柴染棕与湖蓝、金褐、黛紫；分类色保持明度与色相区分。",
    categorical: ["#94613A", "#207D87", "#B68B28", "#80629D"],
    sequential: ["#EDF4F3", "#245F69"],
    diverging: ["#286F83", "#F8F7F3", "#A66635"],
    ink: "#263238",
    muted: "#59666A",
    grid: "#E3E7E6",
  },
  "cn-imperial-orange": {
    ...
    series: "chinese-traditional",
    name: "橙绯红",
    description: "橙绯红与靛青、竹绿、藕紫；冷暖分组。",
    categorical: ["#C65B38", "#3677A3", "#43856A", "#8A6190"],
    sequential: ["#FCF0E7", "#A34427"],
    diverging: ["#3677A3", "#FAF8F3", "#B54F32"],
    ink: "#263238",
    muted: "#59666A",
    grid: "#E3E7E6",
  },
  "cn-wisteria": {
    ...
    series: "chinese-traditional",
    name: "淡藤萝紫",
    description: "藤萝紫与青碧、秋金、玫瑰；避免浅色组分消失在白底。",
    categorical: ["#8263A9", "#267D88", "#B1842E", "#B85D66"],
    sequential: ["#F3EFF8", "#65448B"],
    diverging: ["#6D5298", "#FAF8F5", "#A77B28"],
    ink: "#263238",
    muted: "#59666A",
    grid: "#E3E7E6",
  },
  "cn-sunset": {
    ...
    series: "chinese-traditional",
    name: "瓜瓤粉",
    description: "瓜瓤粉与暮蓝、赭金、松绿；夕照中的清晰分类。",
    categorical: ["#BB687F", "#3C7895", "#AA8429", "#4D8263"],
    sequential: ["#FBEEF1", "#9D4861"],
    diverging: ["#3C7895", "#FBF8F4", "#B66449"],
    ink: "#263238",
    muted: "#59666A",
    grid: "#E3E7E6",
  },
  "cn-hutong": {
    ...
    series: "chinese-traditional",
    name: "蓝墨茶",
    description: "蓝墨茶与瓦赭、烟紫、青绿；以深蓝建立胡同色调。",
    categorical: ["#346B89", "#AF793B", "#89658E", "#39867C"],
    sequential: ["#ECF2F6", "#275671"],
    diverging: ["#346B89", "#F9F7F2", "#A87035"],
    ink: "#263238",
    muted: "#59666A",
    grid: "#E3E7E6",
  },
  "cn-dragon": {
    ...
    series: "chinese-traditional",
    name: "棉絮灰",
    description: "棉絮青灰与古铜、黛紫、苍绿；纹饰色不依赖相近棕灰区分。",
    categorical: ["#61777E", "#A46A3F", "#7B659B", "#3F836F"],
    sequential: ["#EDF3F0", "#386653"],
    diverging: ["#5B708D", "#F8F7F3", "#A66A3F"],
    ink: "#263238",
    muted: "#59666A",
    grid: "#E3E7E6",
  },
  "cn-coral": {
    ...
    series: "chinese-traditional",
    name: "珊瑚朱",
    description: "珊瑚朱与海青、藤紫、苔绿；保留珊瑚主色并增加组间差异。",
    categorical: ["#BF6651", "#427D9E", "#8A649B", "#66823C"],
    sequential: ["#FCF0E9", "#A84C36"],
    diverging: ["#427D9E", "#FCF8F3", "#B65C46"],
    ink: "#263238",
    muted: "#59666A",
    grid: "#E3E7E6",
  },
  "cn-autumn": {
    ...
    series: "chinese-traditional",
    name: "杏叶黄",
    description: "杏叶金与青蓝、胭脂、松绿；深金替代白底难辨的浅黄。",
    categorical: ["#A98225", "#3F7395", "#A35D72", "#4C846A"],
    sequential: ["#FAF3DF", "#8B691F"],
    diverging: ["#3F7395", "#FAF8F0", "#A98225"],
    ink: "#263238",
    muted: "#59666A",
    grid: "#E3E7E6",
  },
